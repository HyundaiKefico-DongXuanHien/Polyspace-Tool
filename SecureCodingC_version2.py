# ============================================================================
# FILE NAME     : SecureCodingC_version2.py
# AUTHOR        : DONG XUAN HIEN
# DIVISION      : HYUNDAI KEFICO Co.,Ltd.
# DESCRIPTION   : Tool auto tracking Secure Coding C from Result_list.txt of Polyspace
# HISTORY       : 24/11/2025
# ============================================================================
...
#---------- Save to CountReport.txt ----------
with open("Result_List.txt", "r", encoding="utf-8") as file:
    for line in file:
        for rule in rules:
            if rule in line:
...
#---------- Save to CountReport.xlsx ----------
# Convert dictionary to DataFrame
df = pd.DataFrame(list(rule_counts.items()), columns=["Rule", "Count"])

# Save to Excel
df.to_excel("CountReport.xlsx", index=False)

print("Summary saved to CountReport.xlsx")
